...
static const commandDef_t commandList[] = {
	...
	{"+CIPSNTPTIME?", MODE_EXACT_MATCH, CMD_AT_CIPSNTPTIME}},
						  {"+CIPDNS", MODE_QUERY_SET, CMD_AT_CIPDNS}, {"+CIPDNS_CUR", MODE_QUERY_SET, CMD_AT_CIPDNS_CUR}, {"+CIPDNS_DEF", MODE_QUERY_SET, CMD_AT_CIPDNS_DEF},

						  {"+SYSCPUFREQ", MODE_QUERY_SET, CMD_AT_SYSCPUFREQ}, {"+RFMODE", MODE_QUERY_SET, CMD_AT_RFMODE}, {"+CIPSSLAUTH", MODE_QUERY_SET, CMD_AT_CIPSSLAUTH}, {"+CIPSSLFP", MODE_QUERY_SET, CMD_AT_CIPSSLFP}, {"+CIPSSLCERTMAX", MODE_QUERY_SET, CMD_AT_CIPSSLCERTMAX}, {"+CIPSSLCERT", MODE_QUERY_SET, CMD_AT_CIPSSLCERT}, {"+CIPSSLMFLN", MODE_QUERY_SET, CMD_AT_CIPSSLMFLN}, {"+CIPSSLSTA", MODE_NO_CHECKING, CMD_AT_CIPSSLSTA}, {"+SNTPTIME?", MODE_EXACT_MATCH, CMD_AT_SNTPTIME};
